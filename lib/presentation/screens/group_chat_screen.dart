...
class VoiceGroupChatScreen extends StatefulWidget {
  @override
  _VoiceGroupChatScreenState createState() => _VoiceGroupChatScreenState();
}

class _VoiceGroupChatScreenState extends State<VoiceGroupChatScreen> {
  @override
  ...
  Widget _buildVoiceMessage({
    ...
    Widget mainContent = Expanded(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Sender name (only for group messages and not for "You")
          if (!isMe)
            Padding(
